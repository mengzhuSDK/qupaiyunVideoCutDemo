...
#define	ST_E_FILE_NOT_FOUND -7			///< 模型文件不存在
#define	ST_E_INVALID_FILE_FORMAT -8		///< 模型格式不正确导致加载失败
#define	ST_E_FILE_EXPIRE -9			///< 模型文件过期
...
#define ST_E_SOCKET_INIT_FAILED -25		///< socket初始化失败
#define ST_E_SOCKET_NO_VERSION_TWO_POINT_TWO -26///< Windows下特定错误，没有socket2.2版本
#define ST_E_GET_HOST_ERROR -27			///< 无法解析验证服务器的地址
