...
public class EffectLoader {
    ...
    public int loadAllPaster(final LoadCallback<ResourceForm> callback) {

        mService.loadEffectPaster(null
    ...
    public int loadAllMV(final LoadCallback<IMVForm> callback) {

        mService.loadEffectMv(null
