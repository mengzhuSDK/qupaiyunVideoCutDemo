...
public class PasterUITextImpl extends PasterUIGifImpl{
    ...
    public PasterUITextImpl(Activity mActivity ,AliyunPasterView pasterView, AliyunPasterController controller, TimelineBar timelineBar){
        this(mActivity,pasterView, controller, timelineBar, false);
    }

    public PasterUITextImpl(Activity mActivity , AliyunPasterView pasterView, AliyunPasterController controller, TimelineBar timelineBar, boolean completed) {
