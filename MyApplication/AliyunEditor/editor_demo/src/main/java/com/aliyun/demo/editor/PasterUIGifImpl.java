...
public class PasterUIGifImpl extends PasterUISimpleImpl {
    ...
    public PasterUIGifImpl(AliyunPasterView pasterView, AliyunPasterController controller, TimelineBar timelineBar, boolean completed) {
...
//        }
    ...
    public void moveToCenterBottom() {
        mPasterView.post(new Runnable() {
            @Override
            public void run() {
                int cx = mController.getPasterCenterX();
