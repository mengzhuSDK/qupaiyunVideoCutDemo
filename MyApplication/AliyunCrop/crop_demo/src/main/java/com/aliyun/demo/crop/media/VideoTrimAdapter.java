...
public class VideoTrimAdapter extends BaseAdapter {
    ...
    public VideoTrimAdapter(Context context, int duration, int durationLimit,
...
//        return (int) Math.round(count);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.thumblayout = (SquareFrameLayout) convertView.findViewById(R.id.video_tailor_frame);
            holder.thumbImage = (ImageView) convertView.findViewById(R.id.video_tailor_img_item);
