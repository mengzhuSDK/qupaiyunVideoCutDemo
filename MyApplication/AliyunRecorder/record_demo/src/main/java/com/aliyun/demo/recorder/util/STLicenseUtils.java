...
//            LogUtils.e(TAG, "read license data error");
        ...
        if (activateCode == null || (STMobileAuthentificationNative.checkActiveCodeFromBuffer(licenseBuffer, licenseBuffer.length(), activateCode) == 0)) {
//            LogUtils.e(TAG, "activeCode: " + (activateCode == null));
            activateCode = STMobileAuthentificationNative.generateActiveCodeFromBuffer(licenseBuffer, licenseBuffer.length());
