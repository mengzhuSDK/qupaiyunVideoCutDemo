...
public class PageRecyclerView extends RecyclerView {
    ...
    public class PageAdapter extends Adapter<ViewHolder> {
        ...
        public PageAdapter(List<?> data, CallBack callBack) {
            ...
            itemCount = dataList.size() + spanRow * spanColumn;//为了保证最后一页不满时也可以滑动，需要多出一页的size
        }
...
//            Log.d("RelativePosition", "position:"+position+", realPosition = "+realPosition);
            return realPosition;
        }
        ...
        private int reflectLayoutPosition(int position) {
            ...
            Log.d("RelativePosition", "position:"+position+", layoutPosition = "+layoutPosition);
